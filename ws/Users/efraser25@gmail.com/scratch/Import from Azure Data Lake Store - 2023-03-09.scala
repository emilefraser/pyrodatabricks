...
val client_id="e643d70b-8281-4367-b181-5c123b0a2402"
val client_credential="mNV8Q~rrPAGNDYdGnsOVJjkiI3ueryA0LxRawcSh"
val directory_id="fa11fdf3-5b03-4237-b894-6183913d4eca" 
val refresh_url="https://login.microsoftonline.com/" + directory_id + "/oauth2/token"
...
val configs = Map(
  ...
  "dfs.adls.oauth2.credential" -> client_credential,
